...
const Create = () => {
  ...
  const CreatePost = async () => {
    try {
      ...
      console.log('Sending request to:', endpoints['create_post'](userId));
      ...
      console.log('Bài đăng đã được tạo thành công:', createPostRes.data);
      Alert.alert('Bài đăng đã được tạo thành công');
      ...
      Alert.alert('Lỗi khi tạo bài đăng');
    }
  };
